...
from src.utils.tools import generate_date_range, get_body_params_pagination, get_total_of_pages
...
class PaginationController:
    ...
    def date_range(
        ...
        for date in dates:
            ...
            body = get_body_params_pagination(action=action, params=params)
            ...
            self.page += 1
            print(f"Page {self.page} fetched. Total of records: {records_fetched}")